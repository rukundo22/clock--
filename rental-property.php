...
<html>
  <body class="mt-0 ">
    ...
    <nav class="navbar " style="background-color: magenta;">
          ...
          <form class="d-flex search col-5 mt-2 " role="search">
            ...
            <button class="btn  dropdown-toggle" id="indexclient" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: aliceblue;color:blue;">
            ...
            <a href="" class="dukanavli nav-item col mt-2" style="color:blue;" id="indexclient"><i class="bi bi-cart4 h3"></i>Cart</a>
           </div>
    </nav>
    ...
    <div class="category  ">
      ...
      <button class="btn  dropdown-toggle fw-bold h4 helpdrop" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="indexclient">
       ...
       <p>
       <span class="m-3 fs-4" style="color:darkmagenta;" id="indexlogoname"> Types:</span>
       </p>
       <div class=" bigWcatego " id="categolist">
        <p >
        <a href="#" class="catego rounded-pill">Houses </a>
         
         <a href="#" class="catego rounded-pill">Machines/Equipment</a>
         <a href="#" class="catego rounded-pill">Trucks/pickups</a>
    ...
    <div class="grid-container m-4 " id="gridcon">
          ...
          <div class="card-body text-center">
               ...
               <div><p class="price">Property Details</p> </div>
              <a href="#" class="btn pricebtn btn-primary row">View</a>
          </div>
          </div>
