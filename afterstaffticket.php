...
<html lang="en">
  ...
  <body class="mt-4 ">
   ...
   <br><br>
   <!-- orders-->
    <div class="easyview text-center m-3">Your Tickets</div>
  
   <!-- table showing your orders-->
   <div class=" container ">
    <div class="row">
      
   <form name="ticketReview" action="afterstaffticket.php" method="POST" target="_self" accept-charset="utf-8" autocomplete="on" class="text-start col" enctype="multipart/form-data">

   <input type="submit" class=" view m-1 rounded " placeholder=" " aria-label=" view your tickets" name="ticketView" value="View" required>
